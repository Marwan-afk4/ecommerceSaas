...
@php
    $paths = [
        ...
        'store' => 'M3 9l1-5h16l1 5M4 9h16v11H4V9zm4 4h.01M12 13h.01M16 13h.01',
...
<svg {{ $attributes->merge(['class' => 'h-4 w-4']) }} fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
